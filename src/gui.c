...
void pauseMenu (button **resume, button **options, button **quit){
    SDL_FRect *boxResume = createRect(WINDOW_WIDTH / 2 - 150, WINDOW_HEIGHT / 2 - 37.5 - 90, 300.0f, 75.0f);
    SDL_FRect *boxOptions = createRect(WINDOW_WIDTH / 2 - 150, WINDOW_HEIGHT / 2 - 37.5, 300.0f, 75.0f);
    SDL_FRect *boxQuit = createRect(WINDOW_WIDTH / 2 - 150, WINDOW_HEIGHT / 2 - 37.5 + 90, 300.0f, 75.0f);
